  ...
  const toCreate = [
    {
      ...
      password: process.env.BOOTSTRAP_OPERATOR_PASSWORD || process.env.BOOTSTRAP_ADMIN_PASSWORD,
      role_id: byName.Operator,
    },
    {
      name: 'Report Viewer',
      email: 'viewer@notificationengine.com',
      password: process.env.BOOTSTRAP_VIEWER_PASSWORD || process.env.BOOTSTRAP_ADMIN_PASSWORD,
